...
class Catalogs::SuppliersControllerTest < ActionController::TestCase
  ...
  test "should create catalogs_supplier" do
    assert_difference('Catalogs::Supplier.count') do
      post :create, catalogs_supplier: { business_name: @catalogs_supplier.business_name, contact: @catalogs_supplier.contact, email: @catalogs_supplier.email, phones: @catalogs_supplier.phones }
    end
  ...
  test "should update catalogs_supplier" do
    patch :update, id: @catalogs_supplier, catalogs_supplier: { business_name: @catalogs_supplier.business_name, contact: @catalogs_supplier.contact, email: @catalogs_supplier.email, phones: @catalogs_supplier.phones }
    assert_redirected_to catalogs_supplier_path(assigns(:catalogs_supplier))
  end
